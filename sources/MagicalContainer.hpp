...
{   
    ...
    public:
        ...
        class Iterator // abstract class for iterators
        {
            ...
            Iterator& operator=(Iterator&&) = delete; // move assignment operator
        ...
        public:
            ...
            AscendingIterator& operator=(AscendingIterator&&) = delete; // move assignment operator
        ...
        public:
            ...
            SideCrossIterator& operator=(SideCrossIterator&&) = delete; // move assignment operator
        ...
        public:
            ...
            PrimeIterator& operator=(PrimeIterator&&) = delete; // move assignment operator
